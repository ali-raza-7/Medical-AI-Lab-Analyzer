import { UploadCloud, AlertCircle, Activity } from "lucide-react";
...
export function AnalysisUploader({
  ...
  return (
    <div className="space-y-4">
        ...
        >
          <UploadCloud
            className={cn(
              ...
              file ? "text-[#14b8a6]" : "text-slate-300 dark:text-[#64748b]",
            )}
          />
          <div className="text-center">
            <div className="text-xs font-medium text-slate-900 dark:text-white">
              {file ? file.name : "Upload Report Image"}
            </div>
      ...
      {error && (
        <div className="flex items-start gap-2 rounded-lg bg-red-500/10 p-3 text-xs text-red-600 border border-red-200 dark:text-red-400 dark:border-red-500/20">
      ...
      <Button
        className="w-full h-11 bg-[#14b8a6] hover:bg-[#0d9488] text-white font-bold uppercase tracking-widest text-[11px] rounded-lg shadow-lg shadow-[#14b8a6]/20 transition-all hover:-translate-y-0.5"
